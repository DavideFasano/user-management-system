...
<div class="container">
   ...
   <form class="mt-4" action="<?= $action ?>" method="POST">
      ...
      <div class="form-group">
         ...
         <!-- is-invalid  -->
         <input value="<?= $password ?>" class="form-control <?= $passwordClass ?>" name="password" type="text">
      ...
      <div class="input-group mt-4">
         <select class="custom-select" id="inputGroupSelect02">
            ...
            <option value="3">dddddddddd</option>
            <option value="4">ffffffffff</option>
            <option value="5">gggggggggg</option>
         </select>
         <div class="input-group-append">
            <label class="input-group-text" for="inputGroupSelect02">Interessi</label>
         </div>
      </div>
